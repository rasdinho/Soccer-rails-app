...
p6 = Player.create(name: "Sergio Busquts", jersey_num: 5,age: 31,img: "https://realsport101.com/wp-content/uploads/2018/10/busquets-custom.png", position: "MF", team: t1)
...
p8 = Player.create(name: "Arthur Melo", jersey_num: 8, age: 23, img: "https://realsport101.com/wp-content/uploads/2019/02/arthur-custom.png", position: "MF", team: t1)
...
p13 = Player.create(name: "Marcelo Da Silva", jersey_num: 12, age: 32, img: "https://fifadataba.com/images/cards/161.png", position: "DF", team: t2)
...
p28 = Player.create(name: "Fabinho Tavares", jersey_num: 3, age: 26, img: "https://realsport101.com/wp-content/uploads/2019/12/Fabinho-1-198x300.png", position: "MF", team: t3)
p29 = Player.create(name: "Xherdan Shaquiri", jersey_num: 23, age: 28, img: "https://realsport101.com/wp-content/uploads/2018/12/shaqiri-custom.png", position: "MF", team: t3)
...
p31 = Player.create(name: "Sadio Mane", jersey_num: 10, age: 28, img: "https://realsport101.com/wp-content/uploads/2019/11/mane-custom.png", position: "FW", team: t3)
p32 = Player.create(name: "ROBERTO Firmino", jersey_num: 9, age: 28, img: "https://i.imgur.com/zM6NBF5.png", position: "FW", team: t3)
p33 = Player.create(name: "Mohamed Salah", jersey_num: 11, age: 27, img: "https://fifadataba.com/images/cards/20282.png", position: "FW", team: t3)
...
p38 = Player.create(name: "Fernandinho Roza", jersey_num: 25, age: 35, img: "https://www.ultimateteam.co.uk/wp-content/uploads/2016/07/FIFA-17-Fernandinho-Predicted-Card-e1469847521134.png", position: "DF", team: t4)
...
p56 = Player.create(name: "Wojciech Szczesny", jersey_num: 1, age: 30, img: "https://realsport101.com/wp-content/uploads/2019/07/szczesny-custom.png", position: "GK", team: t6)

p57 = Player.create(name: "Alex Sandro", jersey_num: 12, age: 29, img: "https://realsport101.com/wp-content/uploads/2019/10/sandro-custom.png", position: "DF", team: t6)
p58 = Player.create(name: "Matthijs DE Ligt", jersey_num: 4, age: 20, img: "https://realsport101.com/wp-content/uploads/2019/09/de-ligt-custom.png", position: "DF", team: t6)
p59 = Player.create(name: "Giorgio Chiellini", jersey_num: 3, age: 35, img: "https://realsport101.com/wp-content/uploads/2019/11/chiellini-custom-1-212x300.png", position: "DF", team: t6)
p60 = Player.create(name: "Leonardo Bonucci", jersey_num: 13, age: 28, img: "https://realsport101.com/wp-content/uploads/2019/09/ronaldo-custom-3.png", position: "DF", team: t6)

p61 = Player.create(name: "Blaise Matuidi", jersey_num: 14, age: 33, img: "https://realsport101.com/wp-content/uploads/2019/10/matuidi-custom-2.png", position: "MF", team: t6)
p62 = Player.create(name: "Miralem Pjanic", jersey_num: 5, age: 30, img: "https://realsport101.com/wp-content/uploads/2019/10/pjanic-custom-2.png", position: "MF", team: t6)
p63 = Player.create(name: "Juan Cuadrado", jersey_num: 16, age: 31, img: "https://realsport101.com/wp-content/uploads/2019/10/Cuadrado-198x300-1-198x300.png", position: "MF", team: t6)

p64 = Player.create(name: "Douglas Costa", jersey_num: 11, age: 29, img: "https://realsport101.com/wp-content/uploads/2019/08/costa-custom.png", position: "FW", team: t6)
p65 = Player.create(name: "Paulo Dybala", jersey_num: 10, age: 26, img: "https://fifadataba.com/images/cards/135.png", position: "FW", team: t6)
p66 = Player.create(name: "Cristiano Ronaldo", jersey_num: 7, age: 35, img: "https://realsport101.com/wp-content/uploads/2019/06/RONALDO-e1561372549263.png", position: "FW", team: t6)
